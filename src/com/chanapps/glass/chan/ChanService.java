...
public class ChanService extends Service {
    ...
    private static final String LIVE_CARD_ID = "chanforglass";

    /**
     * A binder that gives other components access to the speech capabilities provided by the
     * service.
     */
    public class ChanBinder extends Binder {
        /**
    ...
    private final ChanBinder mBinder = new ChanBinder();
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        if (mLiveCard == null) {
            ...
            RemoteViews views = new RemoteViews(getPackageName(), R.layout.root_card);
            views.setTextViewText(R.id.text, getString(R.string.app_name));
            views.setTextViewText(R.id.footnote, getString(R.string.app_mantra));
            ...
            Intent menuIntent = new Intent(this, ChanBoardListActivity.class);
