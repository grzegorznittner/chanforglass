 ...
 * card.
 */
public class ChanMenuActivity extends Activity {

    private ChanService.ChanBinder mCompassService;
    private boolean mResumed;

    private ServiceConnection mConnection = new ServiceConnection() {
        @Override
        public void onServiceConnected(ComponentName name, IBinder service) {
            if (service instanceof ChanService.ChanBinder) {
                mCompassService = (ChanService.ChanBinder) service;
                openOptionsMenu();
            }
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bindService(new Intent(this, ChanService.class), mConnection, 0);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.read_aloud:
                ...
                return true;
            case R.id.stop:
                stopService(new Intent(this, ChanService.class));
                return true;
            default:
